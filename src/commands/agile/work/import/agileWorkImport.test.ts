...
import { agileWorkImportCommandFactory } from "./agileWorkImport";
...
describe("Agile Work Import Command", () => {
  it("calls set in the content service with cli args", async () => {
    ...
    const agileWorkImport = agileWorkImportCommandFactory();

    await agileWorkImport.setServiceCollection(serviceCollection).parseAsync(
